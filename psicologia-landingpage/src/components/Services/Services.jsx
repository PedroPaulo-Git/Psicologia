...
const Services = () => {
  ...
  const isServiceInView = serviceRefs.map((serviceRef) =>
    useInView(serviceRef, { once: true, threshold: 0.1 })
  );
  useEffect(() => {
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              >
                <p className="mt-4 text-blue-light md:mt-4 md:block md:text-2xl">
                  Somos um casal de psicólogos especializados em oferecer
                  suporte para uma vida mais leve e equilibrada. Trabalhamos
                  juntos para cuidar da sua saúde mental, com foco em temas como
                  depressão, ansiedade, autismo e outros desafios emocionais.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {isServiceInView.map((isServiceVisible, index) => (
              <motion.div
                ...
                initial="hidden"
                animate={isServiceVisible ? "visible" : "hidden"}
              ...
              >
                ...
                >
                      ...
                      {index === 2 && (
                        <span className="z-10 pr-5 pt-2">
                          ...
                          >
                            <g
                              id="feather"
                              transform="translate(988.26 -659.726)"
                            >
                              <path
                  ...
                  <p className="mt-4 text-blue-light md:mt-4 md:block md:text-lg">
                    {index === 0
                      ? "Trabalhamos com casais para promover uma comunicação saudável e soluções de conflitos, criando uma relação mais forte e equilibrada."
                      : index === 1
                      ...
                      : index === 3
                      ? " Oferecemos acompanhamento especializado e técnicas voltadas parao desenvolvimento e bem-estar de pessoas no espectro autista."
                      : index === 4
                      ...
                      : index === 5
                      ? " Auxiliamos casais ou indivíduos a reconstruir suas vidas emocionais e psicológicas após um divórcio ou separação."
                      : "Ajudamos na escolha de carreira e no desenvolvimento profissional, proporcionando orientações para o futuro."}
                  </p>
                </a>
              </motion.div>
            ))}
